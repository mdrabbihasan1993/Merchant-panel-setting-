        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-6 border-t border-slate-100 flex justify-end">
            <button 
              type="submit" 
              disabled={isUpdating}
              className="flex items-center gap-2 px-8 py-3 bg-brand-dark text-white font-bold rounded-xl shadow-lg hover:shadow-slate-900/30 transition-all active:scale-95 disabled:opacity-70"
            >
