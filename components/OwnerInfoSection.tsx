        ...
        <div className="p-8 space-y-8">
          ...
          <div className="flex items-center gap-6">
            <div className="relative group">
              <div className="w-24 h-24 rounded-2xl bg-slate-100 border-2 border-dashed border-slate-300 flex items-center justify-center overflow-hidden transition-all group-hover:border-brand-orange/50">
                <img src="https://picsum.photos/seed/merchant/200" alt="Owner" className="w-full h-full object-cover" />
              ...
              <button className="absolute -bottom-2 -right-2 p-1.5 bg-brand-orange text-white rounded-lg shadow-lg hover:scale-110 transition-transform">
                <Camera size={14} />
              </button>
            </div>
            <div>
              <h3 className="font-bold text-brand-dark text-lg">Profile Photo</h3>
              <p className="text-sm text-slate-500 font-medium">Click to update your merchant avatar</p>
            </div>
          </div>
